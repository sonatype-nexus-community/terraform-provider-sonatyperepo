...
`, resourceTypeHosted, randomString, resourceTypeProxy, randomString, resourceTypeGroup, randomString, randomString, resourceTypeProxy),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceHostedName, "raw.content_disposition", "ATTACHMENT"),
					...
					resource.TestCheckResourceAttr(resourceProxyName, "raw.content_disposition", "ATTACHMENT"),
					...
					resource.TestCheckResourceAttr(resourceGroupName, "raw.content_disposition", "ATTACHMENT"),
				),
			},

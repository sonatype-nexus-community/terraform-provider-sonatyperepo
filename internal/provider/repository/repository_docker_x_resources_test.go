...
`, resourceTypeHosted, randomString, resourceTypeProxy, randomString, resourceTypeGroup, randomString, randomString, resourceTypeProxy),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(resourceHostedName, "docker.force_basic_auth", "true"),
					resource.TestCheckResourceAttr(resourceHostedName, "docker.v1_enabled", "true"),
					...
					resource.TestCheckResourceAttr(resourceProxyName, "docker.force_basic_auth", "true"),
					resource.TestCheckResourceAttr(resourceProxyName, "docker.v1_enabled", "true"),
					...
					resource.TestCheckResourceAttr(resourceGroupName, "docker.force_basic_auth", "false"),
					resource.TestCheckResourceAttr(resourceGroupName, "docker.v1_enabled", "false"),
				),
			},

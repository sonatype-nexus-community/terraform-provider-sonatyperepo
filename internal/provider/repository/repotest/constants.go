...
const (
	...
	RES_ATTR_OCI_FORCE_BASIC_AUTH                             string = "oci.force_basic_auth"
	RES_ATTR_OCI_V1_ENABLED                                   string = "oci.v1_enabled"
	RES_ATTR_OCI_PROXY_CACHE_FOREIGN_LAYERS                   string = "oci_proxy.cache_foreign_layers"
	RES_ATTR_OCI_PROXY_INDEX_TYPE                             string = "oci_proxy.index_type"
	RES_ATTR_OCI_COSIGN_ENFORCEMENT                           string = "cosign.enforcement"

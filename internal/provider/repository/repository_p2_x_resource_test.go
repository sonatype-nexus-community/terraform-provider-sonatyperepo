...
`, resourceTypeProxy, randomString),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify Proxy
					resource.TestCheckResourceAttr(resourceProxyName, "name", fmt.Sprintf("p2-proxy-repo-%s", randomString)),
					...
					resource.TestCheckResourceAttr(resourceProxyName, "proxy.remote_url", "https://download.eclipse.org/releases/2025-06"),
...
func TestAccRepositoryP2ProxyInvalidMaxAgeNegative(t *testing.T) {
	randomString := acctest.RandStringFromCharSet(10, acctest.CharSetAlphaNum)

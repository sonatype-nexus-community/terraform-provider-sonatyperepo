...
const RES_NAME_FORMAT string = "%s.repo"
...
func TestAccRepositoryRubyGemsResource(t *testing.T) {
	...
	resourceGroupName := fmt.Sprintf(RES_NAME_FORMAT, resourceTypeGroup)
	resourceHostedName := fmt.Sprintf(RES_NAME_FORMAT, resourceTypeHosted)
	resourceProxyName := fmt.Sprintf(RES_NAME_FORMAT, resourceTypeProxy)

...
var (
	RES_NAME_BLOB_STORE_FILE  string = fmt.Sprintf("%s.test", RES_TYPE_BLOB_STORE_FILE)
	RES_NAME_BLOB_STORE_GCS   string = fmt.Sprintf("%s.test", RES_TYPE_BLOB_STORE_GCS)
	RES_NAME_BLOB_STORE_GROUP string = fmt.Sprintf("%s.test", RES_TYPE_BLOB_STORE_GROUP)
	RES_NAME_BLOB_STORE_S3    string = fmt.Sprintf("%s.test", RES_TYPE_BLOB_STORE_S3)
)

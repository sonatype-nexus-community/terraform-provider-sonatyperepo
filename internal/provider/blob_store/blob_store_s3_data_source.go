...
func (d *s3BlobStoreDataSource) Schema(_ context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dsschema.Schema{
		...
		Attributes: map[string]dsschema.Attribute{
			...
			"soft_quota":   tfschema.DataSourceComputedOptionalSingleNestedAttribute("Soft Quota for this Blob Store", map[string]dsschema.Attribute{"type": tfschema.DataSourceComputedString("Soft Quota type"), "limit": tfschema.DataSourceComputedInt64("Quota limit")}),
			"bucket_configuration": tfschema.DataSourceComputedSingleNestedAttribute("Bucket Configuration for this Blob Store", map[string]dsschema.Attribute{
				"bucket": tfschema.DataSourceComputedSingleNestedAttribute("Main Bucket Configuration for this Blob Store", map[string]dsschema.Attribute{
					...
					"name":   tfschema.DataSourceComputedString("The name of the S3 bucket"),
					"prefix": tfschema.DataSourceComputedString("The S3 blob store (i.e S3 object) key prefix"),
				}),
				"encryption": tfschema.DataSourceComputedSingleNestedAttribute("Bucket Encryption Configuration for this Blob Store", map[string]dsschema.Attribute{
					"encryption_type": tfschema.DataSourceComputedString("The type of S3 server side encryption to use. Either 's3ManagedEncryption' or 'kmsManagedEncryption'"),
					"encryption_key":  tfschema.DataSourceComputedString("The encryption key"),
				}),
				"bucket_security": tfschema.DataSourceComputedSingleNestedAttribute("Bucket Security Configuration for this Blob Store", map[string]dsschema.Attribute{
					"access_key_id":     tfschema.DataSourceComputedString("An IAM access key ID for granting access to the S3 bucket"),
					"secret_access_key": tfschema.DataSourceComputedString("The secret access key associated with the specified IAM access key ID"),
					"role":              tfschema.DataSourceComputedString("An IAM role to assume in order to access the S3 bucket"),
					"session_token":     tfschema.DataSourceComputedString("An AWS STS session token associated with temporary security credentials which grant access to the S3 bucket"),
				}),

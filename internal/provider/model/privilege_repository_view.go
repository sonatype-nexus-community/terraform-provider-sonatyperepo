...
// PrivilegeRepositoryViewModel
// ------------------------------------
type PrivilegeRepositoryViewModel struct {
...
func (p *PrivilegeRepositoryViewModel) MapToApi(api *sonatyperepo.ApiPrivilegeRepositoryViewRequest) {

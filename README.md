...
We test on the latest patch release of each the earliest and latest version of Terraform i.e. `1.5.x` and  `1.13.x` - i.e. we aim to support all Terraform versions since `1.5.0` (earlier verions may also work, but are not tested and bugs will not be actioned if they are proven to affect these earlier versions).
...
[shield_tf_version]: https://img.shields.io/badge/Terraform-1.5.0+-blue
...
[link_nxrm_release]: https://help.sonatype.com/en/sonatype-nexus-repository-3-86-0-release-notes.html

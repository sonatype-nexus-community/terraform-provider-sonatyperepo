...
page_title: "sonatyperepo_repository_docker_proxy Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Proxy DOCKER Repositories
---

# sonatyperepo_repository_docker_proxy (Resource)
...
- `docker_proxy` (Attributes) Docker Proxy specific configuration for this Repository (see [below for nested schema](#nestedatt--docker_proxy))

...
page_title: "sonatyperepo_repository_nuget_proxy Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Proxy NUGET Repositories
---

# sonatyperepo_repository_nuget_proxy (Resource)
...
- `nuget_proxy` (Attributes) Nuget specific configuration for this Repository (see [below for nested schema](#nestedatt--nuget_proxy))
...
<a id="nestedatt--nuget_proxy"></a>
### Nested Schema for `nuget_proxy`

Required:

- `nuget_version` (String) Nuget Protocol Versions

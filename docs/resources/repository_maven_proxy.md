...
page_title: "sonatyperepo_repository_maven_proxy Resource - terraform-provider-sonatyperepo"
subcategory: ""
description: |-
  Manage Proxy Maven Repositories
---

# sonatyperepo_repository_maven_proxy (Resource)
...
- `authentication` (Attributes) Maven specific configuration for this Repository (see [below for nested schema](#nestedatt--http_client--authentication))

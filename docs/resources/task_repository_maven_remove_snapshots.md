...
page_title: "sonatyperepo_task_repository_maven_remove_snapshots Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Task 'Maven - Delete SNAPSHOT' (repository.maven.remove-snapshots)
---

# sonatyperepo_task_repository_maven_remove_snapshots (Resource)
...
- `repository_name` (String) The Maven repository or repository group to remove snapshots from.

Optional:

- `grace_period_in_days` (Number) The grace period during which snapshots with an associated release will not be deleted.

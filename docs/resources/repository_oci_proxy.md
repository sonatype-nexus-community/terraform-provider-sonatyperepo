...
page_title: "sonatyperepo_repository_oci_proxy Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Proxy OCI Repositories.
...
# sonatyperepo_repository_oci_proxy (Resource)
...
- `oci_proxy` (Attributes) OCI Proxy specific configuration for this Repository (see [below for nested schema](#nestedatt--oci_proxy))
...
<a id="nestedatt--oci_proxy"></a>
### Nested Schema for `oci_proxy`
...
- `index_type` (String) Type of OCI Index
- `index_url` (String) Url of OCI Index to use

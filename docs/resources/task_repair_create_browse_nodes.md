...
page_title: "sonatyperepo_task_repair_create_browse_nodes Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Task 'Repair - Rebuild repository browse' (create.browse.nodes)
---

# sonatyperepo_task_repair_create_browse_nodes (Resource)

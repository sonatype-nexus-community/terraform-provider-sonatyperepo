...
- `conan` (Attributes) Conan Proxy specific configuration for this Repository (see [below for nested schema](#nestedatt--conan))
...
- `conan_version` (String) Conan protocol version. Cannot be changed once repository is created.

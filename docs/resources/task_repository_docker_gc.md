...
page_title: "sonatyperepo_task_repository_docker_gc Resource - sonatyperepo"
subcategory: ""
description: |-
  Manage Task 'Docker - Delete unused manifests and images' (repository.docker.gc)
---

# sonatyperepo_task_repository_docker_gc (Resource)
...
- `repository_name` (String) The Docker repository to clean up.

...
This Provider is tested on Sonatype Nexus Repository Manager versions `3.79.1` through `3.92.0` currently.
...
> [!NOTE]
> Only set this if you are experiencing issues - the default value (2000) should suffice for most scenarios.
